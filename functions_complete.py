...
def refine_str_to_digit(s: str) -> str:
    """Refine string to contain only digits as one continuous string"""
    return "".join([i for i in s if i.isdigit()])


def refine_str_to_float(s: str) -> float:
    """Refining string to float"""
    text = ""
